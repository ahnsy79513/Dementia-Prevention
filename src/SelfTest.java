...
public class SelfTest extends JPanel implements ActionListener {
	...
	private void initQuestions() {
		...
		QuestionItem q1 = new QuestionItem(1, selfTestPage1, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q1;

		QuestionItem q2 = new QuestionItem(1, selfTestPage1, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q2;

		QuestionItem q3 = new QuestionItem(1, selfTestPage1, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q3;

		QuestionItem q4 = new QuestionItem(1, selfTestPage1, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q4;

		QuestionItem q5 = new QuestionItem(1, selfTestPage1, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q5;

		QuestionItem q6 = new QuestionItem(1, selfTestPage1, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q6;

		QuestionItem q7 = new QuestionItem(1, selfTestPage1, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q7;

		// 2Page selfTestPage2 사용
		QuestionItem q8 = new QuestionItem(2, selfTestPage2, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q8;

		QuestionItem q9 = new QuestionItem(2, selfTestPage2, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q9;

		QuestionItem q10 = new QuestionItem(2, selfTestPage2, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q10;

		QuestionItem q11 = new QuestionItem(2, selfTestPage2, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q11;

		QuestionItem q12 = new QuestionItem(2, selfTestPage2, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q12;

		QuestionItem q13 = new QuestionItem(2, selfTestPage2, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q13;

		QuestionItem q14 = new QuestionItem(2, selfTestPage2, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
		questions[number++] = q14;

		QuestionItem q15 = new QuestionItem(2, selfTestPage2, number, "질문입니다. 답변해주세요. 반갑습니다. 예시입니다.", fontText);
